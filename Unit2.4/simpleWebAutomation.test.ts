...
describe("Employee Manager 1.2", () => {
 ...
 //line 55 we had to use the const value instead of the declared const from above
        ...
        expect(
            await (await driver.findElement(By.name("nameEntry"))).getAttribute("")
        ).not.toBe("Bernice");
        });
...
//broken still don't know why
        expect(
            await (await driver.findElement(By.name("nameEntry"))).getAttribute("Phillip Weaver")
        ).not.toBe("Phillip Weaver");
    });
    ...
    test("A saved change persists", async () => {
        ...
        */
        ...
        await driver.findElement(By.name("employee1")).click();
        expect(
            await (await driver.findElement(By.name("nameEntry"))).getAttribute("value")
        ).toBe("Test Name");
});
    ...
    test("lets you cancel out of an error message", async () => {
        ...
        */
        ...
        await driver.findElement(By.name("cancel")).sendKeys(Key.SPACE);
        await driver.findElement(By.name("cancel")).click();
